#!/usr/bin/env python3
# from ha4detr import hungarian_gpu
...
def demo():
    """
    Test the implementation of hungarian_batch from this mode
    - Args
        A 3D float batched cost tensor of shape [B, _MAX_ROWS, _MAX_COLS],
    ...
    - Returns A 3D integer tensor of shape [B, _MAX_ROWS, 2], where each (Ni, 2)
    ...
    for i in range(loops):
        ...
        # GPU implementation
        gpu_t, gpu_out = timeit(hungarian_batch, cost, Ns)
        ...
        try:
            ...
            if err < 1e-4:
                ...
                raise AssertionError("Something wrong in GPU implementation.")
